## [6d6b21f] — 2026-03-25 17:26 (МСК)
📦 Sprint 2: SQL оптимизация, retry, авто-парсинг, скелетоны, индикация парсинга

## [0a87c02] — 2026-03-25 16:55 (МСК)
📦 Social Monitor Sprint 1: sparkline реальные данные, rate-limit парсинга, дедупликация провайдера, toast заглушки
...
## [5b6987a] — 2026-03-18 23:11 (МСК)
📦 Fix: кнопка Сохранить больше не скрывается за нижним таббаром (pb-28)


## [f07efce] — 2026-03-18 23:15 (МСК)
📦 Fix: кнопка Сохранить в оверлее редактирования активности — sticky, яркий gradient, pb-28


## [11baac4] — 2026-03-18 23:19 (МСК)
📦 Адаптивный layout блока «Рабочий вес» — заголовок и dropdown в столбец, truncate для длинных названий упражнений


## [e1cd50f] — 2026-03-18 23:31 (МСК)
📦 Классификатор: добавлены глаголы-действий (поехать, сходить, забрать, позвонить и др.) в _REMINDER_STRONG; создан _REMINDER_NORMAL с временными маркерами (завтра в, послезавтра, дни недели); подключён в classify_by_rules и has_any_signal — sticky nutrition больше не поглощает задачи


## [cb44cd5] — 2026-03-20 10:52 (МСК)
📦 Auth: TTL initData увеличен с 1ч до 24ч (Telegram кеширует initData), добавлены debug-логи для 401 ошибок
