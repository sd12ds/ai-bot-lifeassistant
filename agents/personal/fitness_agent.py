...
- "💡 Настрой расписание: «день 1 по пятницам с 21 до 22», «день 2 в среду»"
- "💡 Редактируй: «замени X на Y», «добавь X в день 2», «убери X»"
- "💡 Или открой мини-приложение для визуального редактора"
