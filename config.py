...
# Модель для классификатора намерений (быстрая, дешёвая, точная классификация)
OPENAI_CLASSIFIER_MODEL: str = os.getenv("OPENAI_CLASSIFIER_MODEL", "gpt-4.1-nano")
# Модель для агентов (качественное понимание контекста, tool calling)
OPENAI_AGENT_MODEL: str = os.getenv("OPENAI_AGENT_MODEL", "gpt-4.1-mini")
